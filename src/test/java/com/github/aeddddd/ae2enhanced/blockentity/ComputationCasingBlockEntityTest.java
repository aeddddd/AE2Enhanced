...
/**
 * {@link ComputationCasingBlockEntity} 单元测试.
 * <p>外壳仅作为网格节点,覆盖构造与线缆连接类型.</p>
 */
class ComputationCasingBlockEntityTest {
    ...
    @Test
    void testConstruct() {
        ComputationCasingBlockEntity be = new ComputationCasingBlockEntity(POS, Blocks.STONE.defaultBlockState());
        assertNotNull(be.getMainNode());

        ComputationCasingBlockEntity typed = new ComputationCasingBlockEntity(
                ModBlockEntities.COMPUTATION_CASING.get(), POS, Blocks.STONE.defaultBlockState());
