...
/**
 * {@link AssemblyCasingBlockEntity} 单元测试.
 * <p>外壳仅作为网格节点,覆盖构造与线缆连接类型.</p>
 */
class AssemblyCasingBlockEntityTest {
    ...
    @Test
    void testConstruct() {
        AssemblyCasingBlockEntity be = new AssemblyCasingBlockEntity(POS, Blocks.STONE.defaultBlockState());
        assertNotNull(be.getMainNode());

        AssemblyCasingBlockEntity typed = new AssemblyCasingBlockEntity(
                ModBlockEntities.ASSEMBLY_CASING.get(), POS, Blocks.STONE.defaultBlockState());
