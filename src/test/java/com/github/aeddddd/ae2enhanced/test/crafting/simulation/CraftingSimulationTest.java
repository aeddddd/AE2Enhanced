 ...
 * 源文件:src/test/java/appeng/crafting/simulation/CraftingSimulationTest.java
 * 仅调整包名与导入,用例与断言保持一致,作为原生合成计划系统的回归基线(A 组).
 * 路由层实现后,本测试集必须持续全绿,以证明原生行为零偏差.
 */
package com.github.aeddddd.ae2enhanced.test.crafting.simulation;
