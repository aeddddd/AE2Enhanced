...
public class SpecialPlanInfoTest {
    ...
    public void testSelfDupInfo() {
        ...
        SpecialPlanInfo info = SpecialPlanInfo.compute(env.runDag(mult(stone, 10)));
    ...
    public void testCycleInfo() {
        ...
        SpecialPlanInfo info = SpecialPlanInfo.compute(env.runDag(mult(stone, 8)));
    ...
    public void testCodecRoundTrip() {
        ...
        CraftingJob job = env.runDag(mult(stone, 8));
