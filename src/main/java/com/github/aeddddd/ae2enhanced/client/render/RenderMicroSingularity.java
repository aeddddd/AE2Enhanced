...
public class RenderMicroSingularity extends TileEntitySpecialRenderer<TileMicroSingularity> {
    ...
    private static final double EVENT_HORIZON_RADIUS = 4.0 * MICRO_SCALE;
    private static final double DISK_INNER = 4.6 * MICRO_SCALE;
    private static final double DISK_OUTER = 12.0 * MICRO_SCALE;
    ...
    private void renderShader(TileMicroSingularity te, double x, double y, double z, float partialTicks,
        ...
        try {
            ...
            RenderHelper.drawSphere(EVENT_HORIZON_RADIUS, EVENT_HORIZON_PART_ID, 1.0f,
            ...
            RenderHelper.drawAccretionDisk(DISK_INNER, DISK_OUTER,
