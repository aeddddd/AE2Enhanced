 ...
 * <p>注意：进行中的合成任务不持久化,区块卸载/破坏时集群直接销毁（作为临时替代已足够）.</p>
 */
public class VirtualCraftingCpuBlockEntity extends AENetworkBlockEntity {
    ...
    public VirtualCraftingCpuBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.VIRTUAL_CRAFTING_CPU.get(), pos, state);
    }
    ...
    protected IManagedGridNode createMainNode() {
        return super.createMainNode()
                ...
                .setVisualRepresentation(ModItems.VIRTUAL_CRAFTING_CPU.get());
    }
